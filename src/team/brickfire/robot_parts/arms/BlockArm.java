...
public class BlockArm extends Arm implements ArmMovementCollection {
    ...
    public static final ArmMovement HIGHEST = new RotateToArmMovement(-190, 55);
    ...
    public static final ArmMovement BASKET = new RotateToArmMovement(-105, 15);
    public static final ArmMovement NUDGE = new RotateDistanceArmMovement(-90, 60).chain(new RotateDistanceArmMovement(70, 100));
